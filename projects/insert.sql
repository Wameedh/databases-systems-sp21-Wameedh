...
-- Rule table inserts
INSERT INTO Rule (rule_id, rule) VALUES ( 1, "UPDATE");
INSERT INTO Rule (rule_id, rule) VALUES ( 2, "DELETE");
INSERT INTO Rule (rule_id, rule) VALUES ( 3, "INSERT");

-- User table inserts
INSERT INTO User (user_email, first_name, last_name) VALUES ("wameedh.wf@gmail.com", "wameedh", "Mohammed Ali");
INSERT INTO User (user_id, user_email, first_name, last_name) VALUES (2, "Sara@gmail.com", "Sara", "Smith");
INSERT INTO User (user_id, user_email, first_name, last_name) VALUES (3, "alex@gmail.com", "Alex", "Williams");
...
--
-- -- Role table inserts
-- INSERT INTO Role (role_id, description) VALUES (1, "description-1");
-- INSERT INTO Role (role_id, description) VALUES ( 2, "description-2");
-- INSERT INTO Role (role_id, description) VALUES ( 3,"description-3");
--
...
-- Addresses table inserts Trigger would do the insert
